...
/* Externs ------------------------------------------------------------------*/
extern DJI_Motor_Info_Typedef DJI_Pitch_Motor,Chassis_Motor[4],DJI_Yaw_Motor,DJI_Shoot_Motor[2];

extern DM_Motor_Info_Typedef DM_8009_Motor[4],DM_Pitch_Motor;
