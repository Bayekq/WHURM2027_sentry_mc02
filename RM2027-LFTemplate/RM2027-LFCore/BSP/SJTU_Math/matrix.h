...
public:
    ...
    template<int cols>
    friend Matrixf<_rows, cols>
    operator*(const Matrixf<_rows, _cols>& mat1, const Matrixf<_cols, cols>& mat2) {
        arm_status s;
...
protected:
    ...
    int rows_, cols_;
    // data
    float data_[(_rows * _cols > 0) ? _rows * _cols : 1];
};
...
// Special Matrices
/**
 * @brief 全0矩阵 Zero matrix
 *
 * @tparam _rows 行数
 * @tparam _cols 列数
 * @return Matrixf<_rows, _cols> 全0矩阵
 */
template<int _rows, int _cols>
...
/**
 * @brief 全1矩阵 Ones matrix
 *
 * @tparam _rows 行数
 * @tparam _cols 列数
 * @return Matrixf<_rows, _cols> 全1矩阵
 */
template<int _rows, int _cols>
...
/**
 * @brief 单位矩阵 Identity matrix
 *
 * @tparam _rows 行数
 * @tparam _cols 列数
 * @return Matrixf<_rows, _cols> 单位矩阵
 */
template<int _rows, int _cols>
...
/**
 * @brief 对角矩阵 Diagonal matrix
 *
 * @tparam _rows 行数
 * @tparam _cols 列数
 * @param vec 对角向量
 * @return Matrixf<_rows, _cols> 对角矩阵
 */
template<int _rows, int _cols>
